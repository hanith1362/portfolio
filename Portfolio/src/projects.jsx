...
function Projects() {
  ...
  return (
    <section id="projects">
      <SecHead num="03" label="./projects" title='Six projects. Real systems.<br/><em>Problem → solution → impact.</em>' />
      <div className="shell">
...
function Experience() {
  ...
  return (
    <section id="exp">
      <SecHead num="05" label="./experience" title='Every bullet is a number I moved.' />
      <div className="shell">
      ...
      <div className="shell">
        <div className="sec-body">
          <div className="sec-meta">
            ...
            <div><span className="k">degree</span> <span className="v">MSDS · Bradley</span></div>
        ...
        <div className="contact-grid">
          <div>
            ...
            <p className="contact-sub">
              Summer 2026 internship roles in Data Engineering, Data / AI Analytics, or ML Engineering.
              Also open to part-time contract work if the problem is interesting.
            </p>
          ...
          <div className="contact-card">
            ...
            <div className="ln"><span className="k">location</span><span className="v">{P.location}</span></div>
            <div className="ln"><span className="k">timezone</span><span className="v">{P.timezone}</span></div>
