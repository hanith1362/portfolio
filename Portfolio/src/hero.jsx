...
function TopNav({ active }) {
  const items = [
    ...
    { id: "projects", n: "03", t: "Projects" },
    { id: "datamate", n: "04", t: "Demo" },
    { id: "exp",      n: "05", t: "Experience" },
  ...
  return (
    <div className="shell">
      <div className="status">
        <span className="live">available · summer 2026</span>
        <span className="sep">│</span>
        <span>{window.PORTFOLIO.location}</span>
        <span className="sep">│</span>
        <span>{now} CST</span>
        <span className="sep">│</span>
      ...
      <div className="shell">
        <div className="hero-grid">
          <div className="hero-col-l">
            ...
            <div className="row"><span className="k">/ loc</span><span className="v">{P.location}</span></div>
            <div className="row"><span className="k">/ school</span><span className="v">Bradley · MSDS</span></div>
            <div className="row"><span className="k">/ gpa</span><span className="v">{P.gpa}</span></div>
